    ...
    <div class="relative mx-auto w-full max-w-7xl">
      ...
      <main class="mt-5 space-y-4">
        <section class="rounded-3xl border border-white/70 bg-white/85 p-5 shadow-lg shadow-slate-200/60 backdrop-blur-xl">
          <h2 class="text-2xl font-black tracking-tight text-slate-900 sm:text-3xl">Upload, curate pages, and merge in one click.</h2>
          <p class="mt-2 text-sm text-slate-600 sm:text-base">
            PDFs stay local in your browser. Choose files, fine-tune page selection, set merge order,
          ...
          <article class="rounded-3xl border border-white/70 bg-white/85 p-4 shadow-lg shadow-slate-200/60 backdrop-blur-xl">
            <div class="flex flex-wrap items-center justify-between gap-3">
              ...
              <div class="flex flex-wrap items-center gap-2">
                ...
                <button
                  class="hidden rounded-xl border border-rose-300 px-3 py-2 text-sm font-semibold text-rose-700 hover:bg-rose-50"
                  id="remove-a"
                  type="button"
                >
                  Remove
        ...
        <section
          class="flex flex-col gap-4 rounded-3xl border border-white/70 bg-white/85 p-5 shadow-lg shadow-slate-200/60 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between"
          id="merge-panel"
        >
          <div>
          ...
          <button
            class="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-slate-900 to-slate-700 px-6 py-3 text-sm font-extrabold text-white shadow hover:from-slate-800 hover:to-slate-600 disabled:cursor-not-allowed disabled:from-slate-300 disabled:to-slate-300"
            id="merge-btn"
            type="button"
            disabled
          >
